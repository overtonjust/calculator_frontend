...
// Modules
import { clearDisplay, updateDisplay, validateOperands } from '../modules/calcLogic';
    ...
    return (
        <article className='calc'>
            ...
            <section className='calc__row'>
                ...
                <button value={"x"} onClick={(e) => validateOperands(e, display, setDisplay)} className='calc__option-btn'>x</button>
            </section>
            <section className='calc__row'>
